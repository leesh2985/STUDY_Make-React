...
import { fetchPkoemonDetail } from "../Store/pokemonDetailSlice";
...
const PokemonDetail = () => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchPkoemonDetail(name));
  }, [dispatch.name]);
  ...
  return (
    <Container>
      <ImageContainer>
        <Image src={pokemon.images[imageType]} alt={pokemon.koreaName} />
      </ImageContainer>
      <Divider />
      <Body>
        <h2>기본 정보</h2>
        <Table>
          <tbody>
            ...
            <TableRow>
              ...
              <td>{`${pokemon.koreaName} (${pokemon.name})`}</td>
            </TableRow>
            <TableRow>
